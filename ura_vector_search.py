"""
URA Vector Search Module for Chali_App

Easy-to-use module for searching the URA customer service knowledge base.

Usage:
    from ura_vector_search import URAVectorSearch
    
    searcher = URAVectorSearch()
    results = searcher.search("How do I apply for a TIN?")
"""
...
# Configuration
EMBEDDING_MODEL = "all-MiniLM-L6-v2"  # Same as MTN, UEDCL, and NWSC for consistency
COLLECTION_NAME = "ura_customer_service"


class URAVectorSearch:
    """
    Simple interface for searching URA customer service knowledge base.
    ...
    def __init__(
        ...
        if not db_path or not Path(db_path).exists():
            raise FileNotFoundError(
                ...
                f"Please run build_ura_vector_db.py first to create the database."
            )
        ...
        try:
            ...
            raise FileNotFoundError(
                ...
                f"Please run build_ura_vector_db.py first."
            )
        ...
        logger.info("URA Vector Search initialized successfully")
    ...
    def _find_database_path(self) -> Optional[str]:
        ...
        possible_paths = [
            current_dir / "ura_vector_db",  # Same directory as this file
            current_dir.parent / "ura_vector_db",  # Parent directory
            Path(r"D:\BACK UP 1\Personal\Voice Agent\Chali_App\ura_vector_db"),  # Chali_App
        ]
...
if __name__ == "__main__":
    ...
    print("\n" + "="*80)
    print("URA VECTOR SEARCH - TEST MODE")
    print("="*80 + "\n")
