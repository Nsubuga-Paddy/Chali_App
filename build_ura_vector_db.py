"""
Build URA Vector Database from chunks.json

This script reads ura_chunks.json and creates a ChromaDB vector database
for semantic search.

Usage:
    python build_ura_vector_db.py
"""
...
def build_vector_database():
    ...
    if not chunks_path.exists():
        ...
        logger.error("Please make sure ura_chunks.json is in the project root directory")
        return False
...
if __name__ == "__main__":
    print("\n" + "="*80)
    print("URA VECTOR DATABASE BUILDER")
    print("="*80 + "\n")
